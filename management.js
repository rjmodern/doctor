...
const initialSaturdayDocs = [
    ...
    { name: "ডা. নারগীছ আক্তার", specialty: "স্ত্রীরোগ ও প্রসূতি রোগ বিশেষজ্ঞ ও সার্জন", origin: "CMH", room: "121", time: "10:00 AM - 2:00 PM", shift: "সকাল", status: "ON" },
    { name: "ডা. নিগার সুলতানা", specialty: "গাইনী ও প্রসূতি রোগ", origin: "ঢাকা মেডিকেল কলেজ ও হাসপাতাল", room: "159", time: "10:00 AM - 7:00 AM", shift: "সকাল", status: "ON" },
    ...
    { name: "ডাঃ মোঃ সাইয়েদুল আশিক", specialty: "লিভার, গ্যাস্ট্রোএন্টারোজি ও মেডিসিন বিশেষজ্ঞ", origin: "তাজউদ্দিন মেডিকেল", room: "-2", time: "3:30 PM - 8:00 PM", shift: "বিকেল", status: "ON" },
...
const initialWednesdayDocs = [
    ...
    { name: "ডা. মোঃ ইমাদুল ইসলাম (মিঠু)", specialty: "মেডিসিন ও ডায়াবেটিস বিশেষজ্ঞ", origin: "পিজি হাসপাতাল", room: "117", time: "10:00 AM - 3:00 PM", shift: "সকাল", status: "ON" },
    { name: "ডা. নারগীছ আক্তার", specialty: "গাইনী বিশেষজ্ঞ ও সার্জন", origin: "CMH", room: "121", time: "10:00 AM - 2:00 PM", shift: "সকাল", status: "ON" },
